...
Enhancements:
  ...
  * Refactored scrubber code to live in nice Scrubber classes, which
    both cleans the code up and allows developers (that's you!) to
    implement your own filters.
  * Implemented a :nofollow scrubber (thanks Luke Melia!)
