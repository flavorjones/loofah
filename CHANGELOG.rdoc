...
Enhancements:
  ...
  * Refactored scrubber code to live in Scrubber classes, allows developers (that's you!) to write their own scrubbers.
  * Added support for XML documents and fragments.
  * :nofollow HTML scrubber (thanks Luke Melia!)
