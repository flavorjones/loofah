...
Enhancements:
  ...
  * HTML5 whitelist allows `data-*` attributes. (Thanks, Rafael Franca!)
  * HTML5 whitelist allows `<figure>` tags. (Thanks, Kristian Freeman!)
  * HTML5 whitelist allows `poster` and `preload` URI attributes.
